...
include_once('./../db.php');
$result = mysqli_query($DB_conn, 'SELECT * FROM orders');
?>
<html lang="en">
                                ...
                                while ($order = $result->fetch_assoc()) {
                                    switch ($order['payment']) {
                                        ...
                                        case 2:
                                            ...
                                            break;
                                        case 3:
                                            $paymentText = 'Tarjeta de credito';
                                            break;
                                    }
                            ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?= 'https://krokos.com.ar/admin/orderdetail.php?order_id=' . $order['id_order'] ?>">
                                                <button class="btn btn-sm btn-outline-dark">Ver detalle de orden</button>
                                            </a>
                                        </td>
                                    </tr>
                            <?php
